...
-- Généré le :  Jeu 28 Septembre 2017 à 12:05
...
--
ALTER TABLE `Absence`
  ADD PRIMARY KEY (`DateDebut`,`refVisiteur`),
  ADD KEY `FK absence` (`refVisiteur`),
  ADD KEY `FK motif` (`refMotif`);
...
--
ALTER TABLE `Absence`
  ADD CONSTRAINT `FK absence` FOREIGN KEY (`refVisiteur`) REFERENCES `Visiteur` (`id`),
  ADD CONSTRAINT `FK motif` FOREIGN KEY (`refMotif`) REFERENCES `Motif` (`id`);
