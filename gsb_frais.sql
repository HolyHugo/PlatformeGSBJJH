...
CREATE TABLE `Absence` (
  ...
  KEY `FK absence` (`refVisiteur`),
  KEY `FK motif` (`refMotif`),
  CONSTRAINT `FK absence` FOREIGN KEY (`refVisiteur`) REFERENCES `Visiteur` (`id`),
  CONSTRAINT `FK motif` FOREIGN KEY (`refMotif`) REFERENCES `Motif` (`id`)
...
INSERT INTO `Absence` VALUES ('2017-10-02','a17',3,1),('2017-10-03','a17',28,1),('2017-10-05','a131',2,1);
...
INSERT INTO `FicheFrais` VALUES ('a17','10',0,0.00,'2017-10-04','CR'),('e49','09',0,0.00,'2017-09-28','CR');
...
INSERT INTO `LigneFraisForfait` VALUES ('a17','10','ETP',0),('a17','10','KM',0),('a17','10','NUI',0),('a17','10','REP',0),('e49','09','ETP',0),('e49','09','KM',0),('e49','09','NUI',0),('e49','09','REP',0);
...
INSERT INTO `Motif` VALUES (0,'maladie'),(1,'congé');
...
-- Dump completed on 2017-10-05 10:03:54
